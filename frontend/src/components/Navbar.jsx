...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-10 lg:px-20 py-4 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 shadow-lg">
      <h1 className="text-2xl font-extrabold text-white hover:text-gray-100 transition-transform duration-300 hover:scale-105">
        <Link to="/">BlogManage</Link>
      </h1>
      ...
      {path === "/" && (
        <div className="flex items-center space-x-2 bg-white rounded-full px-4 py-1 shadow-md hover:shadow-lg focus-within:shadow-xl transition-all duration-300">
          ...
          <p
            ...
            className="cursor-pointer text-yellow-600 hover:text-yellow-700 transition-transform duration-300 hover:scale-110"
          >
            <BsSearch />
          </p>
        </div>
      ...
      <div className="hidden md:flex items-center space-x-4">
        {user ? (
          ...
          <Link to="/login">
            <button className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-semibold py-1 px-4 rounded-full shadow-md hover:shadow-lg transition-transform duration-300 hover:scale-105">
              Login
            </button>
          </Link>
        )}
        {user ? (
          ...
          <Link to="/register">
            <button className="bg-gradient-to-r from-yellow-600 to-yellow-700 text-white font-semibold py-1 px-4 rounded-full shadow-md hover:shadow-lg transition-transform duration-300 hover:scale-105">
              Register
            </button>
          </Link>
        )}
